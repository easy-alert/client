        ...
        <Style.Content>
          ...
          <Style.ChecklistContainer>
            ...
            <Style.ProgressBarContainer>
              ...
              <Style.ProgressText>
                {`${checklist?.checklistItem?.filter((item) => item.status === 'completed')
                  .length} / ${checklist?.checklistItem?.length} itens concluídos`}
              </Style.ProgressText>
            </Style.ProgressBarContainer>
          ...
          <Style.ContainerBtn>
            {checklist.status !== 'completed' ? (
              <>
                <Button
                  label={checklist.status === 'inProgress' ? 'Parar execução' : 'Iniciar checklist'}
                  bgColor="transparent"
                  textColor="actionBlue"
                  onClick={() =>
                    handleUpdateChecklist(
                      checklist.status === 'inProgress' ? 'pending' : 'inProgress',
                    )
                  }
                />
                <Button
                  ...
                  bgColor="transparent"
                  textColor="actionBlue"
                  onClick={() => handleUpdateChecklist(checklist.status!)}
                />
                <Button
              ...
              <Button label="Fechar" onClick={() => handleModals('modalChecklistDetails', false)} />
            )}
          </Style.ContainerBtn>
        </Style.Content>
      )}
